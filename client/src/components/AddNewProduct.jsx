	...
	return (
		<Tr>
			...
			<Td>
				...
				<Input size='sm' value={name} onChange={(e) => setName(e.target.value)} placeholder='Iphone or Galaxy et.' />
			</Td>
			<Td>
			...
			<Td>
				...
				<FormControl display='flex' alignItems='center'>
					...
					Enable
					<Badge rounded='full' px='1' mx='1' fontSize='0.8em' colorScheme='gren'>
						new
					</Badge>
                    badge?
                    </FormLabel>
